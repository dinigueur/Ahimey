                            ...
                            <ul class="media-list p-0">
                                ...
                                <li class="media d-sm-flex d-block">
                                    <div class="media-left pr-sm-2 pr-0">
                                        <a href="#">
                                            <img class="media-object" src="{{ asset('storage/app-assets/images/pages/search-result.jpg') }}" alt="Generic placeholder image">
                                        </a>
                                    </div>
                ...
                <div class="card bg-transparent border-light shadow-none">
                    <div class="card-body">
                        <div class="text-center">
                            <img class="img-fluid rounded" src="{{ asset('storage/app-assets/images/pages/modern.jpg') }}" alt="logo">
                        </div>
                        ...
                        <div class="knowledge-panel-suggestion">
                            <div class="suggestion-1 d-inline-block text-center mr-2">
                                <a href="https://1.envato.market/apex_admin" target="_blank">
                                    <img src="{{ asset('storage/app-assets/images/pages/1-apex.png') }}" alt="Image description" height="40" width="40">
                                    <span class="font-small-2 d-block">Apex</span>
                                </a>
                            </div>
                            <div class="suggestion-1 d-inline-block text-center mr-2">
                                <a href="https://1.envato.market/convex_angular_admin" target="_blank">
                                    <img src="{{ asset('storage/app-assets/images/pages/3-convex.png') }}" alt="Image description" height="40" width="40">
                                    <span class="font-small-2 d-block">Convex</span>
                                </a>
                            </div>
                            <div class="suggestion-1 d-inline-block text-center mr-2">
                                <a href="https://1.envato.market/materialize_admin" target="_blank">
                                    <img src="{{ asset('storage/app-assets/images/pages/4-materialize.png') }}" alt="Image description" height="40" width="40">
                            ...
                            <div class="suggestion-1 d-inline-block text-center">
                                <a href="https://1.envato.market/stack_admin" target="_blank">
                                    <img src="{{ asset('storage/app-assets/images/pages/2-stack.png') }}" alt="Image description" height="40" width="40">

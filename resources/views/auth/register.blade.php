...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset(!\App::environment('local') ? 'public' : ''.'storage/app-assets/css/pages/authentication.css') }}">
    <!-- END: Page CSS-->
                        ...
                        <div class="card bg-authentication rounded-0 mb-0">
                            <div class="row m-0">
                                <div class="col-lg-6 d-lg-block d-none text-center align-self-center pl-0 pr-3 py-0">
                                    <img src="{{ asset(!\App::environment('local') ? 'public' : ''.'storage/app-assets/images/pages/register.jpg') }}" alt="branding logo">
                                </div>
                                        ...
                                        <div class="card-content">
                                            ...
                                            <form action="{{ route('register') }}" method="POST">
                                                @csrf
                                                    ...
                                                    <input type="text" id="inputName" class="form-control" placeholder="Name" required name="name" value="{{ old('name') }}">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="email" id="inputEmail" class="form-control" placeholder="Email" required name="email" value="{{ old('email') }}">
                                                    ...
                                                    <div class="form-label-group">
                                                        <input type="text" id="inputPhone" class="form-control" placeholder="Téléphone" value="{{ old('phone') }}" required name="phone">
                                                    ...
                                                    <div class="form-label-group">
                                                    <input type="text" id="inputAddress" class="form-control" value="{{ old('address') }}" placeholder="Ex : BP 358, Cotonou, Bénin, Rue 300 Révérend Père Colineau, lot 5252, zongo" required name="address">
                                                    ...
                                                    <a href="{{ route('login') }}" class="btn btn-outline-primary float-left btn-inline mb-50">S'identifier</a>
